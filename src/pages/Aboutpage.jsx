...
import image61 from "../components/Assets/Pumas2.jpg";
import image62 from "../components/Assets/Pumas5.jpg";
import image63 from "../components/Assets/Pumas4.jpg";
import image64 from "../components/Assets/Pumas3.jpg";
import image65 from "../components/Assets/Pumas12.jpg";
...
const AboutPage = () => {
  return (
    ...
    <div className="about-content">
      ...
      Moreover, restricted access to suitable sports venues for roller hockey practice, combined with inadequate conditions of the available spaces, significantly hinders progress and the formation of new talent in the discipline.<br/> <br/>
      However, the club has made significant progress by hosting and organizing three tournaments of its own, called the Pumas Cup, in the years 2017, 2018, and 2019. Additionally, in 2021, a one-week camp was conducted under the guidance of the former coach of the Colombian Roller Hockey National Team, Portuguese André Mato, who highlighted the club's commitment to training and sports development.<br/> <br/>
      <img src={image65} alt="Pumas team" />
